...
__webpack_require__.d(controller_namespaceObject, {
  ...
  "documentController": () => (controller_document),
...
;// CONCATENATED MODULE: ./backend/services/document.ts

const document_prisma = new client_namespaceObject.PrismaClient();
const document_GET = ({ id  })=>{
    return document_prisma.document.findUnique({
        where: {
            id
        }
    });
...
const getList = ()=>{
    return document_prisma.document.findMany({});
};
const getBySpecificIndex = ({ index  })=>{
    return document_prisma.document.findFirst({
        where: {
            specific_index: index
        }
    });
};
const document_POST = (item)=>{
    return document_prisma.document.create({
        data: item
    });
};
const document_PATCH = (item)=>{
    const { id  } = item;
    return document_prisma.document.update({
        where: {
            id
        },
        data: item
...
const document_DELETE = (id)=>{
    return document_prisma.document.delete({
        where: {
            id
        }
    });
...
/* harmony default export */ const services_document = (document_category);
...
const order_categoryController = {
    ...
    DELETE: async (param)=>{
        return await order.DELETE(param);
    },
    getOrderInfo: async (data)=>{
        return await order.getOrderInfo();
    },
    yesterdayOrderInfo: async ()=>{
        return await order.yesterdayOrderInfo();
    },
    todayOrderInfo: async ()=>{
        return await order.todayOrderInfo();
    },
    timeTrigger: async ()=>{
        return await order.timeTrigger();
    }
};
...
;// CONCATENATED MODULE: ./backend/controller/document.ts

const documentController = {
    GET: async (param)=>{
        return await services_document.GET(param);
    },
    list: async ()=>{
        return await services_document.getList();
    },
    getBySpecificIndex: async (param)=>{
        return await services_document.getBySpecificIndex(param);
    },
    POST: async (item)=>{
        return await services_document.POST(item);
    },
    PATCH: async (item)=>{
        return await services_document.PATCH(item);
    },
    DELETE: async (id)=>{
        return await services_document.DELETE(id);
    }
};
/* harmony default export */ const controller_document = (documentController);
...
var __webpack_exports__ = (__webpack_exec__(4865));
